//
//  MiniBallAddDevicesVC.swift
//  ProjectDemoSwift
//
//  Created by pingguo on 2019/1/11.
...
class MiniBallAddDevicesVC: RootViewController, UITableViewDelegate, UITableViewDataSource, CBCentralManagerDelegate, CBPeripheralDelegate {
        ...
        if let characteristics = service.characteristics {
            for characteristic in characteristics {
                if characteristic.uuid == CBUUID.init(string: "8888") {
                    MiniBallManager.shared.deviceCharMap[service.peripheral] = characteristic
                }
    ...
    override func TableViewConfig() {
        self.tableView.register(UINib.init(nibName: "MiniBallAddDevicesTVC", bundle: nil), forCellReuseIdentifier: "MiniBallAddDevicesTVC")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MiniBallAddDevicesTVC") as! MiniBallAddDevicesTVC
